import{_ as a,e as n}from"./app.2a01fc36.js";var s="/assets/01.1d4b598f.png",e="/assets/03.3e8d85ba.png",t="/assets/02.60efbe9b.png",c="/assets/04.0eb799ae.png",o="/assets/05.abea999c.png",p="/assets/06.dbfe2508.png",d="/assets/07.02f27cb9.png",r="/assets/08.80d18391.png";const l={},i=n(`<h2 id="_1-\u6587\u4EF6\u7BA1\u7406\u547D\u4EE4" tabindex="-1"><a class="header-anchor" href="#_1-\u6587\u4EF6\u7BA1\u7406\u547D\u4EE4" aria-hidden="true">#</a> 1. \u6587\u4EF6\u7BA1\u7406\u547D\u4EE4</h2><h3 id="_1-1-\u521B\u5EFA\u547D\u4EE4-mkdir\u3001touch" tabindex="-1"><a class="header-anchor" href="#_1-1-\u521B\u5EFA\u547D\u4EE4-mkdir\u3001touch" aria-hidden="true">#</a> 1.1 \u521B\u5EFA\u547D\u4EE4\uFF1A<code>mkdir</code>\u3001<code>touch</code></h3><p><strong>\u521B\u5EFA\u76EE\u5F55\u547D\u4EE4\uFF1A<code>mkdir</code></strong></p><div class="language-text ext-text"><pre class="language-text"><code>-p: \u9012\u5F52\u521B\u5EFA\u76EE\u5F55
-v: \u663E\u793A\u8FC7\u7A0B
...
<span class="token function">mkdir</span> -pv /linux-76/11/22/33/44/55
...
<span class="token function">rm</span> -f /student.txt

<span class="token comment"># \u5220\u9664 /linux-76 \u76EE\u5F55\u3002\u8BE5\u76EE\u5F55\u4E0B\u6709\u5F88\u591A\u5B50\u76EE\u5F55\uFF0C\u5E0C\u671B\u9012\u5F52\u5220\u9664</span>
<span class="token function">rm</span> -rf /linux-76/
...
<span class="token function">cp</span> -r /etc /tmp/etc_back
...
<span class="token punctuation">\\</span>cp -r /etc/hostname /etc/fstab /var/ /home/ /tmp/ /root/ /backup/
...
<span class="token function">head</span> -5 /etc/passwd
...
\u6CE8\uFF1A\u5982\u679C -<span class="token operator">&lt;</span>N<span class="token operator">&gt;</span> \u4E0D\u8D77\u4F5C\u7528\uFF0C\u53EF\u4EE5\u5C1D\u8BD5\u7528 -n<span class="token operator">&lt;</span>N<span class="token operator">&gt;</span>\u3002\u5982\u6253\u5370\u6700\u540E <span class="token number">5</span> \u884C: -5 \u6216 -n5
...
<span class="token function">tail</span> -20 /etc/passwd

<span class="token comment"># \u6253\u5370\u6587\u4EF6\u6700\u540E 20 \u884C\u5185\u5BB9\uFF0C\u5E76\u901A\u8FC7\u7BA1\u9053 | \u4F20\u9012\u7ED9 head \u547D\u4EE4\u5904\u7406\uFF0C\u6253\u5370\u51FA\u6700\u540E 20 \u884C\u5185\u5BB9\u4E2D\u7684\u524D 10 \u884C\u5185\u5BB9</span>
<span class="token function">tail</span> -20 /etc/passwd <span class="token operator">|</span> <span class="token function">head</span>

<span class="token comment"># \u5B9E\u65F6\u8FFD\u8E2A\u6587\u4EF6\u5C3E\u90E8\u7684\u5185\u5BB9\u53D8\u5316</span>
<span class="token function">tail</span> -f /etc/passwd
...
<span class="token function">wget</span> -O /tmp/test.repo http://mirrors.aliyun.com/repo/Centos-7.repo
...
<span class="token function">curl</span> -o /tmp/curl.repo http://mirrors.aliyun.com/repo/Centos-7.repo
...
<span class="token function">sort</span> -t <span class="token string">&quot;.&quot;</span> -k3.1,3.1 -k4.1,4.3 -n ip.txt
...
<span class="token function">wc</span> -l /etc/services
</code></pre></div><h4 id="_5-2-1-\u793A\u4F8B\u4EE3\u7801-\u7EDF\u8BA1-etc-passwd-\u6587\u4EF6\u4E2D\u4EE5-nologin-\u7ED3\u5C3E\u7684\u884C\u6570" tabindex="-1"><a class="header-anchor" href="#_5-2-1-\u793A\u4F8B\u4EE3\u7801-\u7EDF\u8BA1-etc-passwd-\u6587\u4EF6\u4E2D\u4EE5-nologin-\u7ED3\u5C3E\u7684\u884C\u6570" aria-hidden="true">#</a> 5.2.1 \u793A\u4F8B\u4EE3\u7801\uFF1A\u7EDF\u8BA1 <code>/etc/passwd</code> \u6587\u4EF6\u4E2D\u4EE5 <code>nologin</code> \u7ED3\u5C3E\u7684\u884C\u6570</h4><p><img src="`+d+'" alt="" loading="lazy"></p><h4 id="_5-2-2-\u7EDF\u8BA1\u6587\u4EF6\u884C\u53F7\u7684\u51E0\u79CD\u65B9\u6CD5" tabindex="-1"><a class="header-anchor" href="#_5-2-2-\u7EDF\u8BA1\u6587\u4EF6\u884C\u53F7\u7684\u51E0\u79CD\u65B9\u6CD5" aria-hidden="true">#</a> 5.2.2 \u7EDF\u8BA1\u6587\u4EF6\u884C\u53F7\u7684\u51E0\u79CD\u65B9\u6CD5</h4><p><img src="'+r+`" alt="" loading="lazy"></p><h3 id="_5-3-\u8FC7\u6EE4\u884C-\u8FC7\u6EE4\u5217-grep-awk" tabindex="-1"><a class="header-anchor" href="#_5-3-\u8FC7\u6EE4\u884C-\u8FC7\u6EE4\u5217-grep-awk" aria-hidden="true">#</a> 5.3 \u8FC7\u6EE4\u884C &amp; \u8FC7\u6EE4\u5217\uFF1A<code>grep</code> &amp; <code>awk</code></h3><div class="language-text ext-text"><pre class="language-text"><code>\u8FC7\u6EE4\u5217\u65F6\u8981\u60F3\u5230 awk \u547D\u4EE4\uFF1B
\u8FC7\u6EE4\u884C\u65F6\u8981\u60F3\u5230 grep \u547D\u4EE4\u3002
...
<span class="token function">grep</span> -i <span class="token string">&quot;ftp&quot;</span> /etc/passwd

<span class="token comment"># \u5728 /etc/passwd \u6587\u4EF6\u4E2D\u8FC7\u6EE4\u51FA\u6392\u9664\u4E86\u5305\u542B ftp \u4E4B\u5916\u7684\u5176\u4ED6\u884C</span>
<span class="token function">grep</span> -v <span class="token string">&quot;ftp&quot;</span> /etc/passwd
...
<span class="token function">grep</span> -Ei <span class="token string">&quot;sync$|ftp&quot;</span> /etc/passwd

<span class="token comment"># \u5728 /var/log/secure \u6587\u4EF6\u4E2D\u8FC7\u6EE4\u51FA\u5305\u542B Failed \u7684\u884C\uFF0C\u5E76\u6253\u5370\u5B83\u7684\u4E0B\u9762 2 \u884C\u3002</span>
<span class="token function">grep</span> -n -A <span class="token number">2</span> <span class="token string">&quot;Failed&quot;</span> /var/log/secure

<span class="token comment"># \u5728 /var/log/secure \u6587\u4EF6\u4E2D\u8FC7\u6EE4\u51FA\u5305\u542B Failed \u7684\u884C\uFF0C\u5E76\u6253\u5370\u5B83\u7684\u4E0A\u9762 2 \u884C\u3002</span>
<span class="token function">grep</span> -n -B <span class="token number">2</span> <span class="token string">&quot;Failed&quot;</span> /var/log/secure

<span class="token comment"># \u5728 /var/log/secure \u6587\u4EF6\u4E2D\u8FC7\u6EE4\u51FA\u5305\u542B Failed \u7684\u884C\uFF0C\u5E76\u6253\u5370\u5B83\u7684\u4E0A\u4E0B 2 \u884C\u3002</span>
<span class="token function">grep</span> -n -C <span class="token number">2</span> <span class="token string">&quot;Failed&quot;</span> /var/log/secure
...
<span class="token function">awk</span> -F <span class="token string">&#39;:&#39;</span> <span class="token string">&#39;{print $1,$3}&#39;</span> /etc/passwd 
...
</code></pre></div>`,102);function g(u,h){return i}var m=a(l,[["render",g],["__file","_05_linux_basic_cmd.html.vue"]]);export{m as default};
